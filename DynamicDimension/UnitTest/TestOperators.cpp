...
TEST_F(OperatorsTest, DimensionMultiplication) {
   ...
   ASSERT_DOUBLE_EQ(myTest.GetVal(UnitList(LengthUnits::Meters(), TimeUnits::Seconds()), UnitList()), 50.0);

   // NOTE TO SELF: DIVISION STILL NEEDS THE CORRESPONDING UPDATE, ONLY DID MULTIPLY FOR NOW

   ASSERT_DOUBLE_EQ(myTest.GetVal(UnitList(LengthUnits::Feet(), TimeUnits::Minutes()), UnitList()), 2.73403333333333333);
...
TEST_F(OperatorsTest, DimensionDivision) {
   ...
   ASSERT_DOUBLE_EQ(myTest.GetVal(UnitList(LengthUnits::Meters()), UnitList(TimeUnits::Seconds())), 10.0);
   ASSERT_DOUBLE_EQ(myTest.GetVal(UnitList(LengthUnits::Feet()), UnitList(TimeUnits::Minutes())), 1968.504);
...
TEST_F(OperatorsTest, ScalarMultiplication)
{
   ...
   ASSERT_DOUBLE_EQ(mySpeed.GetVal(UnitList(LengthUnits::Meters()), UnitList(TimeUnits::Seconds())), 10.0);
   ...
   ASSERT_DOUBLE_EQ(mySpeed.GetVal(UnitList(LengthUnits::Meters()), UnitList(TimeUnits::Seconds())), 20.0);
   ASSERT_DOUBLE_EQ(mySpeed.GetVal(UnitList(LengthUnits::Feet()), UnitList(TimeUnits::Seconds())), 65.6168);
   ASSERT_DOUBLE_EQ(mySpeed.GetVal(UnitList(LengthUnits::Meters()), UnitList(TimeUnits::Minutes())), 1200.0);
   ASSERT_DOUBLE_EQ(mySpeed.GetVal(UnitList(LengthUnits::Feet()), UnitList(TimeUnits::Minutes())), 3937.008);
}
...
TEST_F(OperatorsTest, ScalarDivision)
{
   ...
   ASSERT_DOUBLE_EQ(mySpeed.GetVal(UnitList(LengthUnits::Meters()), UnitList(TimeUnits::Seconds())), 5.0);
   ASSERT_DOUBLE_EQ(mySpeed.GetVal(UnitList(LengthUnits::Feet()),   UnitList(TimeUnits::Seconds())), 16.4042);
   ASSERT_DOUBLE_EQ(mySpeed.GetVal(UnitList(LengthUnits::Meters()), UnitList(TimeUnits::Minutes())), 300.0);
   ASSERT_DOUBLE_EQ(mySpeed.GetVal(UnitList(LengthUnits::Feet()),   UnitList(TimeUnits::Minutes())), 984.252);
}
