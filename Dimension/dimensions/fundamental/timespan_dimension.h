...
using scale = factor_t<
   std::ratio<1, 1>,
   std::tuple<ratio_exponent<std::ratio<2, 1>, -2, 1>, ratio_exponent<std::ratio<3, 1>, -1, 1>, ratio_exponent<std::ratio<5, 1>, -1, 1>>>;
};
template<> struct Conversion<seconds, hours>
{
using scale = factor_t<
   std::ratio<1, 1>,
   std::tuple<ratio_exponent<std::ratio<2, 1>, -4, 1>, ratio_exponent<std::ratio<3, 1>, -2, 1>, ratio_exponent<std::ratio<5, 1>, -2, 1>>>;
};
