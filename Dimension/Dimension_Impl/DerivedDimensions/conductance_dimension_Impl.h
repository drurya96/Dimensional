...
namespace dimension
{
   ...
   concept is_conductance_as = dimension_convertible_to<T, Rep,
   ...
   [[maybe_unused]]
   constexpr typename DimType::rep get_conductance_as(const DimType& obj)
   {
   ...
   class conductance<Named, Cs...> : public base_dimension_from_tuple<double, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
   ...
   class conductance<Rep, Named, Cs...> : public base_dimension_from_tuple<Rep, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
   ...
   constexpr auto make_conductance(Cs... coeffs)
   {
      ...
      return conductance<double, T0, T1, T2, T3, Cs...>(1.0);
   }
   ...
   {
      ignore_unused(coeffs...);
      return conductance<Rep, T0, T1, T2, T3, Cs...>(value);
   }
   ...
   {
      ignore_unused(coeffs...);
      return conductance<double, Named, Cs...>(1.0);
   }
   ...
   {
      ignore_unused(coeffs...);
      return conductance<Rep, Named, Cs...>(value);
   }
