...
namespace dimension
{
   ...
   [[maybe_unused]]
   constexpr DimType::rep get_diffusion_coefficient_as(const DimType& obj)
   {
   ...
   class diffusion_coefficient<Named, Cs...> : public base_dimension_from_tuple<double, typename Named::units, std::tuple<Cs...>>::dim
   {
   public:
   ...
   class diffusion_coefficient<Rep, Named, Cs...> : public base_dimension_from_tuple<Rep, typename Named::units, std::tuple<Cs...>>::dim
   {
   public:
