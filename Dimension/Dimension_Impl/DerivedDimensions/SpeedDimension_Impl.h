...
namespace Dimension
{
   ...
   struct is_speed<BaseDimension<std::tuple<LengthT>, std::tuple<TimeT>>> : std::bool_constant<IsSpeedUnits<LengthT, TimeT>> {};
   ...
   template<typename LengthT, typename TimeT>
   struct is_speed<Speed<LengthT, TimeT>> : std::bool_constant<IsSpeedUnits<LengthT, TimeT>> {};
