...
namespace dimension
{
   ...
   template<typename T>
   concept IsNamedmagnetic_fluxUnit =
   ...
   concept is_magnetic_flux_as = dimension_convertible_to<T, Rep,
   ...
   template<typename T>
   concept is_magnetic_flux = is_magnetic_flux_as<T, double>;
   ...
   [[maybe_unused]]
   constexpr typename DimType::rep get_magnetic_flux_as(const DimType& obj)
   {
   ...
   requires are_magnetic_flux_units<
      ...
      T3
   >
   class magnetic_flux<T0, T1, T2, T3, Cs...> : public base_dimension_impl<double,
      ...
      unit_exponent<typename unit_filter<timespanType, T0, T1, T2, T3>::type, -1>,
   ...
   requires are_magnetic_flux_units<
      ...
      T3
   >
   class magnetic_flux<Rep, T0, T1, T2, T3, Cs...> : public base_dimension_impl<Rep,
      unit_exponent<typename unit_filter<massType, T0, T1, T2, T3>::type, 1>,
      unit_exponent<typename unit_filter<lengthType, T0, T1, T2, T3>::type, 2>,
      unit_exponent<typename unit_filter<timespanType, T0, T1, T2, T3>::type, -1>,
      unit_exponent<typename unit_filter<chargeType, T0, T1, T2, T3>::type, -1>,
   ...
   class magnetic_flux<Named, Cs...> : public base_dimension_from_tuple<double, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
   ...
   class magnetic_flux<Rep, Named, Cs...> : public base_dimension_from_tuple<Rep, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
   ...
   constexpr auto make_magnetic_flux(Cs... coeffs)
   {
      ...
      return magnetic_flux<double, T0, T1, T2, T3, Cs...>(1.0);
   }
   ...
   {
      ignore_unused(coeffs...);
      return magnetic_flux<Rep, T0, T1, T2, T3, Cs...>(value);
   }
   ...
   {
      ignore_unused(coeffs...);
      return magnetic_flux<double, Named, Cs...>(1.0);
   }
   ...
   {
      ignore_unused(coeffs...);
      return magnetic_flux<Rep, Named, Cs...>(value);
   }
