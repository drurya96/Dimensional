...
namespace dimension
{
   ...
   class molar_mass<Named, Cs...> : public base_dimension_from_tuple<double, typename Named::units, std::tuple<Cs...>>::dim
   {
   public:
   ...
   class molar_mass<Rep, Named, Cs...> : public base_dimension_from_tuple<Rep, typename Named::units, std::tuple<Cs...>>::dim
   {
   public:
