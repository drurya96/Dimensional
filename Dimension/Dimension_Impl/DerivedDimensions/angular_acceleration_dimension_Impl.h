...
namespace dimension
{
   ...
   template<typename T>
   concept IsNamedangular_accelerationUnit =
   ...
   concept is_angular_acceleration_as = dimension_convertible_to<T, Rep,
   ...
   [[maybe_unused]]
   constexpr typename DimType::rep get_angular_acceleration_as(const DimType& obj)
   {
   ...
   class angular_acceleration<Named, Cs...> : public base_dimension_from_tuple<double, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
   ...
   class angular_acceleration<Rep, Named, Cs...> : public base_dimension_from_tuple<Rep, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
