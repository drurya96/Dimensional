...
namespace dimension
{
   ...
   [[maybe_unused]]
   constexpr typename DimType::rep get_pressure_as(const DimType& obj)
   {
   ...
   class pressure<Named, Cs...> : public base_dimension_from_tuple<double, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
   ...
   class pressure<Rep, Named, Cs...> : public base_dimension_from_tuple<Rep, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
