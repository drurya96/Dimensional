...
namespace dimension
{
   ...
   concept is_density_as = dimension_convertible_to<T, Rep,
      unit_exponent<primary_mass, 1>, 
      unit_exponent<primary_length, -3>
   >;

   template<typename T>
   concept is_density = is_density_as<T, double>;
   ...
   class density<Named, Cs...> : public base_dimension_from_tuple<double, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
   ...
   class density<Rep, Named, Cs...> : public base_dimension_from_tuple<Rep, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
   ...
   constexpr auto make_density(Cs... coeffs)
   {
      ...
      return density<double, T0, T1, Cs...>(1.0);
   }
   ...
   {
      ignore_unused(coeffs...);
      return density<Rep, T0, T1, Cs...>(value);
   }
   ...
   {
      ignore_unused(coeffs...);
      return density<double, Named, Cs...>(1.0);
   }
