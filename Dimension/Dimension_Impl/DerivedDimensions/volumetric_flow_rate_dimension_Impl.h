...
namespace dimension
{
   ...
   template<typename T>
   concept IsNamedvolumetric_flow_rateUnit =
   ...
   template<typename T>
   concept is_volumetric_flow_rate = is_volumetric_flow_rate_as<T, double>;
   ...
   [[maybe_unused]]
   constexpr typename DimType::rep get_volumetric_flow_rate_as(const DimType& obj)
   {
   ...
   class volumetric_flow_rate<Named, Cs...> : public base_dimension_from_tuple<double, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
   ...
   class volumetric_flow_rate<Rep, Named, Cs...> : public base_dimension_from_tuple<Rep, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
   ...
   constexpr auto make_volumetric_flow_rate(Cs... coeffs)
   {
      ...
      return volumetric_flow_rate<double, T0, T1, Cs...>(1.0);
   }
   ...
   {
      ignore_unused(coeffs...);
      return volumetric_flow_rate<Rep, T0, T1, Cs...>(value);
   }
   ...
   {
      ignore_unused(coeffs...);
      return volumetric_flow_rate<double, Named, Cs...>(1.0);
   }
   ...
   {
      ignore_unused(coeffs...);
      return volumetric_flow_rate<Rep, Named, Cs...>(value);
   }
