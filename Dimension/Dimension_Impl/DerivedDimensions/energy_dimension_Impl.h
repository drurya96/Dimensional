...
namespace dimension
{
   ...
   [[maybe_unused]]
   constexpr DimType::rep get_energy_as(const DimType& obj)
   {
   ...
   class energy<Named, Cs...> : public base_dimension_from_tuple<double, typename Named::units, std::tuple<Cs...>>::dim
   {
   public:
   ...
   class energy<Rep, Named, Cs...> : public base_dimension_from_tuple<Rep, typename Named::units, std::tuple<Cs...>>::dim
   {
   public:
