...
namespace dimension
{
   ...
   template<typename T>
   concept is_resistance = is_resistance_as<T, double>;
   ...
   [[maybe_unused]]
   constexpr typename DimType::rep get_resistance_as(const DimType& obj)
   {
   ...
   requires are_resistance_units<
      ...
      T3
   >
   class resistance<T0, T1, T2, T3, Cs...> : public base_dimension_impl<double,
   ...
   requires are_resistance_units<
      ...
      T3
   >
   class resistance<Rep, T0, T1, T2, T3, Cs...> : public base_dimension_impl<Rep,
      unit_exponent<typename unit_filter<massType, T0, T1, T2, T3>::type, 1>,
      unit_exponent<typename unit_filter<lengthType, T0, T1, T2, T3>::type, 2>,
      unit_exponent<typename unit_filter<timespanType, T0, T1, T2, T3>::type, -1>,
      unit_exponent<typename unit_filter<chargeType, T0, T1, T2, T3>::type, -2>,
   ...
   class resistance<Named, Cs...> : public base_dimension_from_tuple<double, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
   ...
   class resistance<Rep, Named, Cs...> : public base_dimension_from_tuple<Rep, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
