...
namespace dimension
{
   ...
   concept IsNamedtorqueUnit =
      ...
      is_angle_unit<typename std::tuple_element_t<3, unit_units_t<T>>::unit> &&
   ...
   [[maybe_unused]]
   constexpr typename DimType::rep get_torque_as(const DimType& obj)
   {
   ...
   class torque<Named, Cs...> : public base_dimension_from_tuple<double, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
   ...
   class torque<Rep, Named, Cs...> : public base_dimension_from_tuple<Rep, unit_units_t<Named>, std::tuple<Cs...>>::dim
   {
   public:
   ...
   constexpr auto make_torque(Cs... coeffs)
   {
      ...
      return torque<double, T0, T1, T2, T3, Cs...>(1.0);
   }
   ...
   {
      ignore_unused(coeffs...);
      return torque<Rep, T0, T1, T2, T3, Cs...>(value);
   }
   ...
   {
      ignore_unused(coeffs...);
      return torque<double, Named, Cs...>(1.0);
   }
   ...
   {
      ignore_unused(coeffs...);
      return torque<Rep, Named, Cs...>(value);
   }
