...
struct conversion_validation_conversion_legality_convertible_units_enable_dimension_casting {
   ...
   template<typename = void>
      static void run() {
         base_dimension<unit_exponent<meters>, unit_exponent<seconds, -1>> a{10.0};
         base_dimension<unit_exponent<Miles>, unit_exponent<Hours, -1>> b = a;
   }
};
...
struct conversion_validation_conversion_legality_missing_conversion_disables_casting {
   ...
   template<typename = void>
      static void run() {
         base_dimension<unit_exponent<meters>, unit_exponent<seconds, -1>> a{10.0};
         base_dimension<unit_exponent<Hours>, unit_exponent<Miles, -1>> b = a;
   }
};
...
struct conversion_validation_conversion_legality_incompatible_physical_dimensions_disallow_conversion {
   ...
   template<typename = void>
      static void run() {
         base_dimension<unit_exponent<meters>, unit_exponent<seconds, -1>> a{10.0};
         base_dimension<unit_exponent<meters>, unit_exponent<seconds, -2>> b = a;
   }
};
