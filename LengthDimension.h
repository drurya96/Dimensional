...
namespace Dimension
{
         ...
         {
            {
               "Meters",
               {
                  ...
                  { "Yard", [](double val) { return val * 1.094; }},
                  { "Inch", [](double val) { return val * 39.3701; }},
                  { "Mile", [](double val) { return val / 1609.0; }},
                  { "NauticalMile", [](double val) { return val / 1852.0; }},
               }
            },
            {
               "Feet",
            ...
            },
            {
               "Yard",
               {
                  { "Meters", [](double val) { return val / 1.094; }},
               }
            },
            {
               "Inch",
               {
                  { "Meters", [](double val) { return val / 39.3701; }},
               }
            },
            {
               "Mile",
               {
                  { "Meters", [](double val) { return val * 1609.0; }},
               }
            },
            {
               "NauticalMile",
               {
                  { "Meters", [](double val) { return val * 1852.0; }},
               }
            },
         };
   ...
   namespace LengthUnits
   {
      ...
      /// @brief Yard singleton
      inline static LengthUnit& Yard() {
         LengthUnit& yard = LengthUnitFactory::GetInstance("Yard");
         return yard;
      }

      /// @brief Inch singleton
      inline static LengthUnit& Inch() {
         LengthUnit& inch = LengthUnitFactory::GetInstance("Inch");
         return inch;
      }

      /// @brief Mile singleton
      inline static LengthUnit& Mile() {
         LengthUnit& mile = LengthUnitFactory::GetInstance("Mile");
         return mile;
      }

      /// @brief NauticalMile singleton
      inline static LengthUnit& NauticalMile() {
         LengthUnit& nauticalMile = LengthUnitFactory::GetInstance("NauticalMile");
         return nauticalMile;
      }
   }
