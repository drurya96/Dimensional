...
namespace StaticDimension
{
   ...
   struct MassUnit : public BaseUnit<MassUnit<Unit>>
   { 
   public: 
   ...
   public:
      ...
      Mass() : BaseDimension<std::tuple<Unit>, std::tuple<>>(0.0, std::tuple<Unit>{}, std::tuple<>{}) {}

      Mass(double val) : BaseDimension<std::tuple<Unit>, std::tuple<>>(val, std::tuple<Unit>{}, std::tuple<>{}) {}
   ...
   template<>
   inline double ConvertDouble<Grams, Pounds>(double input)
   {
      return input * 0.0022046226;
   }

   template<>
   inline double ConvertDouble<Pounds, Grams>(double input)
   {
      return input / 0.0022046226;
   }

   template<>
   inline double ConvertDouble<Grams, Ounces>(double input)
   {
      return input * 0.0352739619;
   }

   template<>
   inline double ConvertDouble<Ounces, Grams>(double input)
   {
      return input / 0.0352739619;
   }
